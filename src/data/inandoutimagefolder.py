...
_all__ = ['InandoutImageFolderDataModule']


@dataclass
class InandoutImageFolderDataModule(LightningDataModule):
    ...
    def __post_init__(self):
        ...
        self.transform = transforms.Compose([
            t for t in [
                transforms.Resize([self.resolution, self.resolution * self.rect_scaler], InterpolationMode.LANCZOS),
    ...
    def _get_dataloader(self, split: str):
        return [DataLoader(self.bgdata[split], **self.dataloader), DataLoader(self.data[split], **self.dataloader)]
