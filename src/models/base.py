...
class BaseModule(LightningModule):
    ...
    # Control flow
    def training_step(self, batch, batch_idx: int, optimizer_idx: Optional[int] = None) -> Tensor:
        return self.shared_step(batch, batch_idx, optimizer_idx, 'train')

    def validation_step(self, batch, batch_idx: int, optimizer_idx: Optional[int] = None):
        return self.shared_step(batch, batch_idx, mode='validate')

    def test_step(self, batch, batch_idx: int, optimizer_idx: Optional[int] = None):
