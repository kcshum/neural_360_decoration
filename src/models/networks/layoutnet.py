...
class LayoutGenerator(nn.Module):
    ...
    def __post_init__(self):
        ...
        if self.use_bg_before_mlp:
            first_dim = self.noise_dim + self.feature_dim + self.style_dim
        else:
            first_dim = self.noise_dim
        self.mlp = StyleMLP(self.mlp_n_layers, self.mlp_hidden_dim, self.mlp_lr_mul, first_dim=first_dim,
